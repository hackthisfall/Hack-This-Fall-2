<template>
  <Container id="schedule">
    <section class="content-section">
      <HashHeader title="SPEAKER SCHEDULE" />
      <div class="contents">
    ...
    return {
      speakers: [
        ...
        },
        {
          ...
          name: "Zac Cohen",
          buttonText: "WATCH NOW",
          date: "5 Oct 2021 18:30",
          endDate: "5 Oct 2021 19:30",
      ...
      .team-card {
        ...
        .speaker-img {
          ...
          .picture-wrapper {
            border-style: solid;
            border-width: 3px;
            border-color: red red #feede3 red;
            width: 100px;
            height: 100px;
            display: flex;
            align-items: center;
